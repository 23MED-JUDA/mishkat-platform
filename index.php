        ...
        <div id="mobileMenu"
            ...
            <div class="flex items-center justify-between px-5 py-4 border-b border-mishkat-green-100/60 bg-gradient-to-l from-mishkat-green-50 to-mishkat-beige-50">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-bold text-mishkat-green-800 text-sm">منصة مشكاة</span>
                </div>
                <button id="closeMobileBtn"
                        class="w-8 h-8 flex items-center justify-center rounded-lg text-mishkat-green-600
                               hover:bg-mishkat-green-100 transition-all duration-200"
            ...
            <nav class="px-4 py-4 space-y-1 flex-1">
                <a href="#hero" class="mobile-nav-link mobile-link-animate flex items-center gap-3 px-4 py-3 text-base font-medium text-mishkat-green-800
                                      ...
                                      rounded-xl transition-all duration-300" role="menuitem" style="--delay:0">
                    <svg class="w-4 h-4 text-mishkat-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l9-9 9 9M5 10v9h14v-9"/></svg>
                    الصفحة الرئيسية
                </a>
                <a href="#packages-section" class="mobile-nav-link mobile-link-animate flex items-center gap-3 px-4 py-3 text-base font-medium text-mishkat-green-800
                                       hover:text-mishkat-green-600 hover:bg-mishkat-green-50/70
                                       rounded-xl transition-all duration-300" role="menuitem" style="--delay:1">
                    <svg class="w-4 h-4 text-mishkat-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                    الباقات
                </a>
                <a href="#teachers" class="mobile-nav-link mobile-link-animate flex items-center gap-3 px-4 py-3 text-base font-medium text-mishkat-green-800
                                          hover:text-mishkat-green-600 hover:bg-mishkat-green-50/70
                                          rounded-xl transition-all duration-300" role="menuitem" style="--delay:2">
                    <svg class="w-4 h-4 text-mishkat-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    المعلمين
                </a>
                <a href="#programs" class="mobile-nav-link mobile-link-animate flex items-center gap-3 px-4 py-3 text-base font-medium text-mishkat-green-800
                                          hover:text-mishkat-green-600 hover:bg-mishkat-green-50/70
                                          rounded-xl transition-all duration-300" role="menuitem" style="--delay:3">
                    <svg class="w-4 h-4 text-mishkat-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18c-2.305 0-4.408.867-6 2.292m0-14.25v14.25"/></svg>
                    البرامج الدراسية
                </a>
                <a href="#faq-section" class="mobile-nav-link mobile-link-animate flex items-center gap-3 px-4 py-3 text-base font-medium text-mishkat-green-800
                                       hover:text-mishkat-green-600 hover:bg-mishkat-green-50/70
                                       rounded-xl transition-all duration-300" role="menuitem" style="--delay:4">
                    <svg class="w-4 h-4 text-mishkat-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    عن المنصة
                </a>
            </nav>
            ...
            <div class="px-4 py-4 border-t border-mishkat-green-100/60 mt-auto">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <a href="dashboard.php"
                       class="mobile-link-animate flex items-center justify-center gap-2 w-full text-center px-5 py-3
                              bg-mishkat-green-700 hover:bg-mishkat-green-600
                              text-white text-sm font-bold rounded-xl
                              transition-all duration-300" style="--delay:5">
